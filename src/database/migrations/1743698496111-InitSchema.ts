...
export class UpdateSchema1743698496111 implements MigrationInterface {
    name = 'UpdateSchema1743698496111'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "usm" ("name" character varying NOT NULL, "address" character varying NOT NULL, "neighborhood" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, CONSTRAINT "PK_2f650a91d1fa3acd6d8c1e571ae" PRIMARY KEY ("name"))`);
        ...
        await queryRunner.query(`CREATE TABLE "symptom_occurrence" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "patient_id" uuid NOT NULL, "symptoms" text, "remarks" text, "disease_occurrence_id" uuid, "registered_date" TIMESTAMP NOT NULL, CONSTRAINT "PK_93d94c53cafa526440a784fcf8c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "chat_message" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "symptom_occurrence_id" uuid NOT NULL, "role" character varying(20) NOT NULL, "message" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3cc0d85193aade457d3077dd06b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "risk_group" ("name" character varying NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_2d626d1cc2753fe537bf18c7b18" PRIMARY KEY ("name"))`);
        await queryRunner.query(`CREATE TABLE "comorbidity" ("name" character varying NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_d00f975661f7329605e1d0e7388" PRIMARY KEY ("name"))`);
